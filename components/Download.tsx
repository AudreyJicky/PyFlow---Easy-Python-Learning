...
const Download: React.FC = () => {
    ...
    const t = translations[currentLang]?.download || translations['English'].download;
        ...
        <div className="max-w-4xl mx-auto py-10 text-center">
            ...
            <div className="mt-16 bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-8 md:p-12 text-white text-left relative overflow-hidden">
                <div className="relative z-10 max-w-lg">
                    <h3 className="text-2xl font-bold mb-4">{t.betaTitle}</h3>
                    <p className="text-slate-300 mb-6">{t.betaDesc}</p>
